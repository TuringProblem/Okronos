...
public class Preset extends QuestTabEntry {
	...
	public static void register() {
		// Make sure we set all the free preset items to ItemDef.free = false so our visibility toggle works
